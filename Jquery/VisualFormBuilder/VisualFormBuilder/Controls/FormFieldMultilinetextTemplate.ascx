<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormFieldMultilinetextTemplate.ascx.cs" Inherits="VisualFormBuilder.Controls.FormFieldMultilinetextTemplate" %>

<script id="form-field-multilinetext-template" type="text/x-jquery-tmpl">
